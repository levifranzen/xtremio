...
def catalog(hash, type, xtr, genre=None, search=None):
    ...
    if type == "tv":
        metas = [
            {"id": f"{xtr}:quality:FHD", "name": "Canais FHD", "poster": "/logo.png", "type": "tv"},
            {"id": f"{xtr}:quality:HD", "name": "Canais HD", "poster": "/logo", "type": "tv"},
            {"id": f"{xtr}:quality:H265", "name": "Canais H265", "poster": "/logo.png", "type": "tv"}
        ]
